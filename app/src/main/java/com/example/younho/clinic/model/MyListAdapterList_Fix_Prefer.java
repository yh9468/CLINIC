...
public class MyListAdapterList_Fix_Prefer extends BaseAdapter {
    ...
    public MyListAdapterList_Fix_Prefer(Context context, ArrayList<Fix_shop> list_item_Array_List)
    {
